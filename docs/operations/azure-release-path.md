...
| P-5 | A valid CAAS Data Use Record or equivalent written authority permits exposing live CAAS-derived data to the allowed single user in an externally accessible flow (issues #26/#27/#28). Absent authority, the externally accessible live-data demonstration fails closed | Data-use record location and approval date, referenced in the PG-04 manifest | `PG-04`, `PG-05` |
