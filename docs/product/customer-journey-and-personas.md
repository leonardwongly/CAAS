...
“All data” means all product-safe normalized flight summaries and route overlays. It does not mean exposing raw CAAS objects, the full reference catalogs, credentials, personal fields, or the airway-name reference list (recorded route-element airway labels are shown on legs).
