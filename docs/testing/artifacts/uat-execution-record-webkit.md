...
Executed 2026-08-15T08:20:51.325Z by a Playwright-driven webkit against the served application
...
| 27 | Keyboard-only pass | All controls reachable by Tab; focus never lost | ☑ pass | 60 stops: BODY:⚠ Safety noticeDemonstration only. Operational weather, NOTA \| INPUT: \| BODY:⚠ Safety noticeDemonstration only. Operational weather, NOTA \| INPUT: \| BODY:⚠ Safety noticeDemonstration only. Operational weather, NOTA \| INPUT: \| BODY:⚠ Safety noticeDemonstration only. Operational weather, NOTA \| INPU |

Screenshots: uat-webkit-01-load.png, uat-webkit-02-search.png, uat-webkit-03-selected.png, uat-webkit-04-routes.png, uat-webkit-05-data.png, uat-webkit-06-edit.png, uat-webkit-07-map-only.png, uat-webkit-08-cleared.png
